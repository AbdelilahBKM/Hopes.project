  ...
  return (
    <div className=" container mx-auto 2xl mt-5">
      <div className="flex  flex-row justify-between pt-5 border-t">
        ...
        <p className="text-gray-300">APRIL 2024 - still in development</p>
      </div>
      ...
      <div className="text-gray-300">
        ...
        <p className="pt-5">
          ...
          students, graduates, and software engineering opportunities. Inspired
          by popular job search websites like Indeed, this project serves as a
      ...
      <div className="text-gray-300">
        ...
        <p className="pt-5">
          This project is a work in progress and serves as a learning experience
          to improve my full-stack development skills. While it&apos;s not fully
          completed, it demonstrates my ability to build functional web
